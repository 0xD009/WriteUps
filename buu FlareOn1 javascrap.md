...
language: [php]
score: 1
flag: "flag{a11.that.java5crap@flare-on.com}"
tags:
- re
- web
---
...
?>
```
很诡异的东西，不知道php里的转义符怎么用的，反正就把有x的当16进制，没x的当十进制，按ASCII编码，最后一行是base64decode第二行，第二行是base64decode第一行
...
最后如法炮制的解
```python
cipher = ' 97 49 49 68 x4F 84 116 x68 97 x74 x44 x4F x54 x6A 97 x76 x61 x35 x63 x72 97 x70 x41 84 x66 x6C 97 x72 x65 x44 65 x53 72 111 110 68 79 84 99 x6F x6D'
cipher = cipher.split()
print(cipher)
